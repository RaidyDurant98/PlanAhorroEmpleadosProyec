Public Class RetirosConsulta
    ...
    Private Sub RetirosConsulta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            Else
                If FiltrarComboBox.SelectedIndex = 1 Then
                    dt = BLL.RetirosBLL.GetTotalRetiros("where Nombres like '%" & FiltrarTextBox.Text & "%'")
                ElseIf FiltrarComboBox.SelectedIndex = 2 Then
                    dt = BLL.RetirosBLL.GetTotalRetiros(" where Descripcion like '%" & FiltrarTextBox.Text & "%'")
                End If
            End If
        End If
    ...
    Private Sub ImprimirButton_Click(sender As Object, e As EventArgs) Handles ImprimirButton.Click
        If dt.Rows.Count > 0 Then
            Dim report As RetirosAhorrosReportViewer = New RetirosAhorrosReportViewer(dt)
            report.Show()
            report.Activate()
        End If
    End Sub
