...
Public Class DepositosEmpleados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AhorrosEmpleados.DepositosEmpleados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDepositosEmpleados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DepositosEmpleados = New DepositosEmpleados()
        rpt.Site = Me.Site
        Return rpt
    End Function
