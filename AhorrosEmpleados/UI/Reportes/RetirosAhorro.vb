...
Public Class RetirosAhorro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AhorrosEmpleados.RetirosAhorro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRetirosAhorro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RetirosAhorro = New RetirosAhorro()
        rpt.Site = Me.Site
        Return rpt
    End Function
