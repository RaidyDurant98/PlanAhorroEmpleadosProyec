...
Public Class SociosAfiliados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AhorrosEmpleados.SociosAfiliados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSociosAfiliados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SociosAfiliados = New SociosAfiliados()
        rpt.Site = Me.Site
        Return rpt
    End Function
