...
Public Class PlanAhorrosReporte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AhorrosEmpleados.PlanAhorrosReporte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPlanAhorrosReporte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PlanAhorrosReporte = New PlanAhorrosReporte()
        rpt.Site = Me.Site
        Return rpt
    End Function
