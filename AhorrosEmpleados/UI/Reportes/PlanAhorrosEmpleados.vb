...
Public Class PlanAhorrosEmpleados
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PlanAhorrosEmpleados.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AhorrosEmpleados.PlanAhorrosEmpleados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPlanAhorrosEmpleados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PlanAhorrosEmpleados = New PlanAhorrosEmpleados()
        rpt.Site = Me.Site
        Return rpt
    End Function
